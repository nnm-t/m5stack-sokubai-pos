...
public:
    JsonIO(const char* file_name, GoodsList* const goods_list, AmountState* const amount_state) : _file_name(file_name), _goods_list(goods_list), _amount_state(amount_state), _json_document(StaticJsonDocument<json_size>())
    {
